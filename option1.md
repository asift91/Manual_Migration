...
- Copy backup archive file(such as moodle.tar.gz , moodeledata.tar.gz , configuration.tar.gz) to Blob storage on Azure.
...
- Restart the nginx and php servers servers.
